...
Summary(pl):	Lista autorow wszystkich klipartow
Group:		-
######		Unknown group!
...
Lista autorow wszystkich klipartow z paczek openclipart-*

%package MISC
Summary:	Misc cliparts
Summary(pl):	Rozne kliparty
Group:		-
######		Unknown group!
...
Kategorie klipartow: activities africa america animal Animal appicon
apple aqua Aqua architecture armoiries arrow asia automobiles baby
bacon ball beach beverages bicycle Biohazard bird book bouquet bowl
breizh britain BSD building business button Button callout candy
cartoon celebrity celtic che chicken Chicken clipboard clock coffe
...
74 klipartow z kategorii "icons".
...
11 klipartow z kategorii "people".
...
26 klipartow z kategorii "ocal_logo".
...
118 klipartow z kategorii "gradients".
...
22 klipartow z kategorii "mime-types".
...
14 klipartow z kategorii "actions".
...
81 klipartow z kategorii "computer".
...
13 klipartow z kategorii "filetype".
...
20 klipartow z kategorii "homes".
...
30 klipartow z kategorii "device".
...
278 klipartow z kategorii "application".
...
10 klipartow z kategorii "filesystems".
...
599 klipartow z kategorii "action".
...
21 klipartow z kategorii "map_symbols".
...
13 klipartow z kategorii "images".
...
7 klipartow z kategorii "animals".
...
22 klipartow z kategorii "signs".
...
456 klipartow z kategorii "unsorted".
...
44 klipartow z kategorii "filesystem".
